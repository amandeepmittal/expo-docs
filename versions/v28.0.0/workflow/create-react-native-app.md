...
If you want to add custom native code to your Expo app, you will need to [use ExpoKit](https://docs.expo.io/versions/v28.0.0/expokit). With CRNA, you have two options: you
